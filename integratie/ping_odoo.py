...
def ping_odoo():
    ...
    try:
        ...
        print(f"✅ Odoo bereikt! Odoo versie: {version_info.get('server_version')}")
        ...
        if uid:
            ...
            print("De XML-RPC verbinding werkt perfect. Integratiescripts kunnen veilig data ophalen wegschrijven!")
        else:
            print("⚠️ Authenticatie mislukt. Controleer of de database bestaat en de inloggegevens in .env correct zijn.")
            sys.exit(1)
            
    except ConnectionRefusedError:
        print("❌ Connectie geweigerd. Odoo container staat waarschijnlijk nog niet aan.")
        sys.exit(1)
